...
import com.javarush.projecthibernate2.entity.*;
...
public class Main {
    ...
    private Customer createCustomer() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            address.setAddress("St. David's st, 22");
            address.setPhone("+380-123-456-7788");
            address.setDistrict("Wrong Hood");
            addressDAO.save(address);

            Customer customer = new Customer();
            customer.setAddress(address);
            customer.setStore(store);
            customer.setFirstName("Anatoly");
            customer.setLastName("Chubyse");
            customer.setActive(true);
            customer.setEmail("tolya@gmail.com");
    ...
    private void customerRentInventory(Customer customer) {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            payment.setAmount(BigDecimal.valueOf(42.42));
